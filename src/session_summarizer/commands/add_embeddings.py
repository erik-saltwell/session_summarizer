...
class AddEmbeddingsCommand(SessionProcessingCommand):
    ...
    def process_session(self, settings: SessionSettings, session_dir: common_paths.Path) -> None:
        ...
        embedded_clips: SpeechClipSet = add_embeddings(settings, session_dir, stitched_clips, False, self, self.logger)
        embedded_clips.save_to_json(session_dir / settings.speech_clips_with_embedding)
